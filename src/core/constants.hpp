...
inline constexpr int GRID_OFFSET_X = 16;
inline constexpr int GRID_OFFSET_Y = 64;
...
inline constexpr float HERO_SPEED = 150.0f;
inline constexpr float HERO_ATTACK_RANGE = 80.0f;
inline constexpr float HERO_ATTACK_COOLDOWN = 0.5f;
inline constexpr int HERO_BASE_DAMAGE = 15;
inline constexpr int HERO_BASE_HP = 200;
inline constexpr int HERO_XP_PER_LEVEL = 100;

inline constexpr float PROJECTILE_SPEED = 300.0f;
...
inline constexpr float WAVE_DELAY = 3.0f;
inline constexpr float SPAWN_INTERVAL = 0.6f;
