...
inline entt::entity create_hero(entt::registry& reg, Vec2 pos) {
    ...
    reg.emplace<AnimatedSprite>(e, AnimatedSprite{.texture_name = assets::HERO_SPRITE,
                                                  .frame_width = 16,
                                                  .frame_height = 16,
                                                  .columns = 4,
                                                  .rows = 7,
                                                  ...
                                                  .display_size = 34.0f,
                                                  .playing = true});
    reg.emplace<Hero>(e, Hero{.level = 1,
                              .xp = 0,
                              .xp_to_next = HERO_XP_PER_LEVEL,
                              .attack_cooldown = 0.0f,
                              .abilities = {Ability{AbilityId::Fireball, 8.0f, 0.0f, 80, 64.0f, 0.0f},
